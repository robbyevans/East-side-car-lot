    ...
    <div class="container px-4 mx-auto">
      <div>
        <div id="title" class="text-center my-10">
          <h1 class="font-bold text-4xl text-white">ABOUT US</h1>
        ...
        >
          ...
          >
            <div id="title" class="w-full py-5 border-b border-gray-800">
              <h2 class="font-bold text-3xl text-white">services</h2>
            ...
            <div id="content" class="">
              <div id="icon" class="my-5">
                ...
                <p class="text-gray-500 text-sm pt-3">
                  we provide the perfect solution to your problem!
                </p>
              </div>
          ...
          >
            <div id="title" class="w-full py-5 border-b border-gray-800">
              <h2 class="font-bold text-3xl text-white">Customers</h2>
              <h3 class="font-normal text-indigo-500 text-xl mt-2">
                $12<sup>,99</sup>/month
              </h3>
            </div>
            <div id="content" class="">
              ...
              <div id="contain" class="leading-8 mb-10 text-lg font-light">
                <ul>
                  <li>24 hours of support</li>
                  <li>24 hours of communication</li>
                  <li>Happy and willing customer services</li>
          ...
          >
            <div id="title" class="w-full py-5 border-b border-gray-800">
              <h2 class="font-bold text-3xl text-white">Contact info</h2>
              <h3 class="font-normal text-indigo-500 text-xl mt-2">
                $19<sup>,99</sup>/month
              </h3>
            </div>
            <div id="content" class="">
              <div id="icon" class="my-5">
                ...
                <p class="text-gray-500 text-sm pt-3">
                  Platform open 24 hours
                </p>
              </div>
              <div id="contain" class="leading-8 mb-10 text-lg font-light">
                <ul>
                  <li>24 hours of support</li>
                  <li>fasts responses</li>
                  <li>flexible</li>
                  <li>happy services</li>
                </ul>
                <div id="choose" class="w-full mt-10 px-6">
                  <a
                    href="#"
